<img src="https://capsule-render.vercel.app/api?type=waving&color=timeGradient&height=250&section=header&text=Luthfi%20Muthathohirin&fontSize=50&animation=fadeIn&fontAlignY=38&desc=Informatics%20Engineering%20-%20AI%20and%20Web%20Dev&descAlignY=58&descAlign=50" width="100%" />
...
<h3 align="left"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=22&pause=1000&color=00B4D8&width=435&lines=ABOUT+ME" alt="About Me" /></h3>
<table>
  <tr>
    <td width="45%" valign="top">
      <h3>👨‍💻 Biodata</h3>
      <ul>
        <li>👤 <b>Name:</b> Luthfi Muthathohirin</li>
        <li>🎓 <b>Education:</b> Universitas Lampung (Informatics)</li>
        <li>📍 <b>Location:</b> Bandar Lampung, Indonesia</li>
        <li>🎯 <b>Focus:</b> AI & Web Development</li>
        <li>📧 <b>Email:</b> luthfirg2502@gmail.com</li>
      </ul>
    </td>
    <td width="55%" valign="top">
      <blockquote>
        <p><b>"Transforming complex data into actionable insights and building robust web architectures."</b></p>
      </blockquote>
      <p>I'm an Informatics Engineering student with a deep passion for artificial intelligence and high-performance systems. I bridge the gap between algorithmic complexity and seamless user experiences.</p>
      <ul>
        <li>🔭 Currently focusing on <b>Decision Support Systems</b> & <b>AI-Automations</b>.</li>
        <li>🌱 Mastering <b>Deep Learning</b>, <b>Next.js</b>, and <b>GIS Architectures</b>.</li>
        <li>🤝 Open for collaborations on <b>Data Science & Web Apps</b>.</li>
      </ul>
    </td>
  </tr>
</table>
